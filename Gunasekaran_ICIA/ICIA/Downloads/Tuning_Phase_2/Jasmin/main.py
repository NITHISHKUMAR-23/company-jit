...
class DemoApp:
    ...
    def serial_communication(ser):
        try:
            ser=serial.Serial(port='/dev/ttyUSB1',baudrate=115200,bytesize=8,parity='N',stopbits=1,timeout=2)   #USB1
            print("✅ Connected to USB1 — waiting for commands or data...")
            return ser
...
def create_app(template_path="", test_api_dir=".", interface_json=""):
    ...
    ser = demo_app.serial_communication()
    ...
    def activeArchive():
        ...
        if request.method == 'PUT':
            ...
            payload = MSG_ID + CONF_HDR_ID + conf_name.encode('utf-8')
...
if __name__ == "__main__":
    ...
    python main.py --config Jasmin_test_250515.prod.interface.json
    
    sudo python /home/jasminuser/Downloads/Tuning_Phase_2/Jasmin/main.py --config /home/jasminuser/Downloads/Tuning_Phase_2/Jasmin/Jasmin_IN_Demo_AIQ-H-P-U_DPL6-0-0_V03_from_V02.prod.interface.json
    ...
    parser.add_argument('-c', '--config',
                        ...
                        required=False,
                        default="Jasmin_test_250515.prod.interface.json")

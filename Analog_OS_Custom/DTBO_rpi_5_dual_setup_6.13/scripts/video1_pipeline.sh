...
media-ctl -d "$MEDIA_DEV" --set-route '"max96724 10-0027" [0/0 -> 6/1 [0x01], 1/0 -> 6/0 [0x01]]'

media-ctl -d "$MEDIA_DEV" --set-route '"csi2" [0/0 -> 1/0 [0x00], 0/1 -> 2/0 [0x01]]'
...
media-ctl -d "$MEDIA_DEV" --set-v4l2 '"max96724 10-0027":6[fmt:SRGGB8_1X8/1920x1080 field:none]'
...
sudo media-ctl -d "$MEDIA_DEV" -l "'csi2':1 -> 'rp1-cfe-csi2-ch0':0 [0]"

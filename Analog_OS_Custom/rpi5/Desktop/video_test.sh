...
media-ctl -d "$MEDIA_DEV" --set-v4l2 '"max96724 10-0027":6/0[fmt:UYVY8_1X16/1920x1080 field:none]'
...
media-ctl -d "$MEDIA_DEV" --set-v4l2 '"max96724 10-0027":6/1[fmt:UYVY8_1X16/1920x1080 field:none]'

...
system/startup_ldf/app_IVT.doj: ../system/startup_ldf/app_IVT.s
	...
	easm21k.exe -file-attr ProjectName="RTOSDemo_CCES_SHARC_21569" -proc ADSP-21569 -si-revision any -D_ADI_THREADS -g -D_DEBUG -D__ADI_FREERTOS -DCORE0 @includes-91cff6f3ea198d0eda909d726667ce70.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_IVT.d" -o "$@" "$<"
...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore SHARC Assembler'
	easm21k.exe -file-attr ProjectName="RTOSDemo_CCES_SHARC_21569" -proc ADSP-21569 -si-revision any -D_ADI_THREADS -g -D_DEBUG -D__ADI_FREERTOS -DCORE0 @includes-91cff6f3ea198d0eda909d726667ce70.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '

...
//-------------------------------------------------------------------
// line "..\src\Time_Slice_Task_Schedule.c":275
	modify(i7,-4) (nw);
	i4=r4;
	dm(-2,i6)=r12;
	dm(-3,i6)=r8;
...
//  No call preserved registers used.
//-------------------------------------------------------------------
// line "..\src\Time_Slice_Task_Schedule.c":259
	modify(i7,-4) (nw);
	i4=r4;
	dm(-2,i6)=r12;
	dm(-3,i6)=r8;
...
//-------------------------------------------------------------------
// line "..\src\Time_Slice_Task_Schedule.c":129
	modify(i7,-2) (nw);
	dm(-3,i6)=r15;
	dm(-2,i6)=r4;
...
.P47L1:
//-------------------------------------------------------------------
//   Loop at "..\src\Time_Slice_Task_Schedule.c" line 130 col 2
//-------------------------------------------------------------------
.LN8:
// line 130
...
//  Registers that could be clobbered by function calls: {r0-r2,r4,r8,r12,s0-s15,i4,i12-i13,b4,b12-b13,m4,m12,ustat1-ustat4,acc,mcc,scc,btf,sacc,smcc,sscc,sbtf,stky,stkyy,mrf,mrb,msf,msb,lcntr,px}
//-------------------------------------------------------------------
// line "..\src\Time_Slice_Task_Schedule.c":147
	modify(i7,-2) (nw);
	dm(-3,i6)=r15;
	dm(-2,i6)=r4;
...
.P52L1:
//-------------------------------------------------------------------
//   Loop at "..\src\Time_Slice_Task_Schedule.c" line 148 col 5
//-------------------------------------------------------------------
.LN20:
// line 148
...
//  Registers that could be clobbered by function calls: {r0-r2,r4,r8,r12,s0-s15,i4,i12-i13,b4,b12-b13,m4,m12,ustat1-ustat4,acc,mcc,scc,btf,sacc,smcc,sscc,sbtf,stky,stkyy,mrf,mrb,msf,msb,lcntr,px}
//-------------------------------------------------------------------
// line "..\src\Time_Slice_Task_Schedule.c":166
	modify(i7,-4) (nw);
	dm(-4,i6)=r4;
.LN32:
// line 167
...
.P54L1:
//-------------------------------------------------------------------
//   Loop at "..\src\Time_Slice_Task_Schedule.c" line 169 col 5
//-------------------------------------------------------------------
.LN34:
// line 169
	r2=dm(-2,i6);
...
//  Registers that could be clobbered by function calls: {r0-r2,r4,r8,r12,s0-s15,i4,i12-i13,b4,b12-b13,m4,m12,ustat1-ustat4,acc,mcc,scc,btf,sacc,smcc,sscc,sbtf,stky,stkyy,mrf,mrb,msf,msb,lcntr,px}
//-------------------------------------------------------------------
// line "..\src\Time_Slice_Task_Schedule.c":184
	modify(i7,-4) (nw);
	dm(-4,i6)=r4;
.LN43:
// line 185
...
.P57L1:
//-------------------------------------------------------------------
//   Loop at "..\src\Time_Slice_Task_Schedule.c" line 187 col 5
//-------------------------------------------------------------------
.LN45:
// line 187
	r2=dm(-2,i6);
...
//-------------------------------------------------------------------
.LN54:
// line "..\src\Time_Slice_Task_Schedule.c":302
...
//  Registers that could be clobbered by function calls: {r0-r2,r4,r8,r12,s0-s15,i4,i12-i13,b4,b12-b13,m4,m12,ustat1-ustat4,acc,mcc,scc,btf,sacc,smcc,sscc,sbtf,stky,stkyy,mrf,mrb,msf,msb,lcntr,px}
//-------------------------------------------------------------------
// line "..\src\Time_Slice_Task_Schedule.c":204
	modify(i7,-2) (nw);
	dm(-2,i6)=r8;
	dm(-3,i6)=r4;
.LN56:
...
.P65L1:
//-------------------------------------------------------------------
//   Loop at "..\src\Time_Slice_Task_Schedule.c" line 242 col 5
//-------------------------------------------------------------------
...
//  Registers that could be clobbered by function calls: {r0-r2,r4,r8,r12,s0-s15,i4,i12-i13,b4,b12-b13,m4,m12,ustat1-ustat4,acc,mcc,scc,btf,sacc,smcc,sscc,sbtf,stky,stkyy,mrf,mrb,msf,msb,lcntr,px}
//-------------------------------------------------------------------
// line "..\src\Time_Slice_Task_Schedule.c":308
	modify(i7,-2) (nw);
	dm(-2,i6)=r15;
.LN70:
// line 309
...
//  Registers that could be clobbered by function calls: {r0-r2,r4,r8,r12,s0-s15,i4,i12-i13,b4,b12-b13,m4,m12,ustat1-ustat4,acc,mcc,scc,btf,sacc,smcc,sscc,sbtf,stky,stkyy,mrf,mrb,msf,msb,lcntr,px}
//-------------------------------------------------------------------
// line "..\src\Time_Slice_Task_Schedule.c":338
	modify(i7,-2) (nw);
	dm(-2,i6)=r8;
	dm(-3,i6)=r4;
.LN91:
...
.P82L1:
//-------------------------------------------------------------------
//   Loop at "..\src\Time_Slice_Task_Schedule.c" line 346 col 2
//-------------------------------------------------------------------
//   This loop executes 1 iteration of the original loop in an estimated 3 
//   cycles (includes 2 stalls).
//-------------------------------------------------------------------
...
//  Registers that could be clobbered by function calls: {r0-r2,r4,r8,r12,s0-s15,i4,i12-i13,b4,b12-b13,m4,m12,ustat1-ustat4,acc,mcc,scc,btf,sacc,smcc,sscc,sbtf,stky,stkyy,mrf,mrb,msf,msb,lcntr,px}
//-------------------------------------------------------------------
// line "..\src\Time_Slice_Task_Schedule.c":355
	modify(i7,-2) (nw);
	dm(-2,i6)=r8;
	dm(-3,i6)=r4;
.LN92:
...
.P84L1:
//-------------------------------------------------------------------
//   Loop at "..\src\Time_Slice_Task_Schedule.c" line 360 col 5
//-------------------------------------------------------------------
...
//-------------------------------------------------------------------
.LN94:
// line "..\src\Time_Slice_Task_Schedule.c":371
	r2=dm(ulErrorFlags.);
	r2=pass r2;
	if eq jump (pc,.P87L2);
...
//  Registers that could be clobbered by function calls: {r0-r2,r4,r8,r12,s0-s15,i4,i12-i13,b4,b12-b13,m4,m12,ustat1-ustat4,acc,mcc,scc,btf,sacc,smcc,sscc,sbtf,stky,stkyy,mrf,mrb,msf,msb,lcntr,px}
//-------------------------------------------------------------------
//  Original Loop at "..\src\Time_Slice_Task_Schedule.c" line 393 col 9 - loop structure removed due to dead code elimination.
//-------------------------------------------------------------------
// line "..\src\Time_Slice_Task_Schedule.c":385
	modify(i7,-2) (nw);
	dm(-3,i6)=r4;
.LN100:
// line 388
...
.P72L1:
//-------------------------------------------------------------------
//   Loop at "..\src\Time_Slice_Task_Schedule.c" line 390 col 5
//-------------------------------------------------------------------
...
.epcabbrev:
	.inc/binary ".\src\Time_Slice_Task_Schedule.sbn", 0, 309;
.epcabbrev.end:
...
.epcdebug:
	...
	.byte =
		...
		0x5F,0x53,0x63,0x68,0x65,0x64,0x75,0x6C,0x65,0x2E,0x63,0x00,
		0x0C;
	.var = .epcline;
	.inc/binary ".\src\Time_Slice_Task_Schedule.sbn", 309, 6742;
...
.epcline:
	.inc/binary ".\src\Time_Slice_Task_Schedule.sbn", 7051, 2143;
	.var = .LNvApplicationGetTimerTaskMemory.;
	.byte =
...
.epcpubnames:
	...
	.var = .epcdebug;
	.inc/binary ".\src\Time_Slice_Task_Schedule.sbn", 9194, 278;
.epcpubnames.end:

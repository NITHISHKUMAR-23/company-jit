...
.epcdebug:
	.byte =
		0xA3,0x03,0x00,0x00,0x02,0x00;
	.var = .epcabbrev;
	.byte =
		0x04,0x01,0x2E,0x2E,0x5C,0x73,0x72,0x63,0x5C,0x4D,0x75,0x74,
		0x65,0x78,0x2E,0x63,0x00,0x0C;
	.var = .epcline;
	.inc/binary ".\src\Mutex.sbn", 0, 903;
.epcdebug.end:
...
.epcline:
	.inc/binary ".\src\Mutex.sbn", 903, 942;
.epcline.end:

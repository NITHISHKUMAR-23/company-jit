...
.epcdebug:
	.byte =
		0xA5,0x03,0x00,0x00,0x02,0x00;
	.var = .epcabbrev;
	.byte =
		0x04,0x01,0x2E,0x2E,0x5C,0x73,0x72,0x63,0x5C,0x54,0x68,0x72,
		0x65,0x61,0x64,0x73,0x2E,0x63,0x00,0x0C;
	.var = .epcline;
	.inc/binary ".\src\Threads.sbn", 0, 903;
.epcdebug.end:
...
.epcline:
	.inc/binary ".\src\Threads.sbn", 903, 944;
.epcline.end:

...
.epcdebug:
	.byte =
		0xA7,0x03,0x00,0x00,0x02,0x00;
	.var = .epcabbrev;
	.byte =
		0x04,0x01,0x2E,0x2E,0x5C,0x73,0x72,0x63,0x5C,0x53,0x65,0x6D,
		0x61,0x70,0x68,0x6F,0x72,0x65,0x2E,0x63,0x00,0x0C;
	.var = .epcline;
	.inc/binary ".\src\Semaphore.sbn", 0, 903;
.epcdebug.end:
...
.epcline:
	.inc/binary ".\src\Semaphore.sbn", 903, 946;
.epcline.end:

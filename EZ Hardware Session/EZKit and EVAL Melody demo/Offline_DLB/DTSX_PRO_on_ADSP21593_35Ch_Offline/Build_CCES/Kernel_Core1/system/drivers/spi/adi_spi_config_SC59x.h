...
#include <stdint.h>
 ...
 ||  defined(__ADSP21594__) || defined(__ADSP21594W__) || defined(__ADSPSC591W__)
...
#define ADI_SPI0_CFG_CLK_BAUD                         50ul
/**************************************************************************************************************/
...
/*! Master or Slave mode of operation\n
    ...
    (0) - Slave mode\n
    (1) - Master mode\n*/
#define ADI_SPI0_CFG_SLAVE_MASTER                     0x0ul
...
#define ADI_SPI0_CFG_CLK_PHASE                        0x0ul
...
/*! Enable SPI MISO mode. This mode is only applicable for SPI as a slave\n
    ...
    (0) - Disable\n
    (1) - Enable\n*/
#define ADI_SPI2_CFG_ENABLE_MISO                      0x1ul
...
/*****************************************************************************************************************/
 ...
 || (__ADSP21594__) || (__ADSP21594W__) || (__ADSPSC591W__)) */

...
struct DTSX_Tag
{
	...
	int StreamType_DTSX;
	int DTSXcommandprocessingdone_c2;
	int DTSX_NumChannel;
	int speakerRemapMask;
	int outputconfig_DTSX;
	int post_pointer;
	int DTSX_Commands[4];
	int DTSX_Processing_enable;
	int NeuralX_Enable;
	int dtsxframecount;

	int ChanReorder_inputConfig;
	int ChannelReorder_DTSX;
	int ChReorder_Done;
	int PP_InputList[13];
	...
	int DTSX_Downsamp_Enable;

	float TempMips;
	int MipsIdx;
	int cycles;
	int ChanReorder_AssignLines_1_6;
	int ChanReorder_AssignLines_7_12;
	int ChanReorder_AssignLines_13_16;

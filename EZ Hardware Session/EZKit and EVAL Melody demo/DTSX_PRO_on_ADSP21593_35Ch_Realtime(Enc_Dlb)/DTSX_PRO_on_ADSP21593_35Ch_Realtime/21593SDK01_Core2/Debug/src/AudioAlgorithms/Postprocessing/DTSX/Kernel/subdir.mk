...
src/AudioAlgorithms/Postprocessing/DTSX/Kernel/DTSX_Kernel_asm.doj: ../src/AudioAlgorithms/Postprocessing/DTSX/Kernel/DTSX_Kernel_asm.asm
	...
	easm21k -file-attr ProjectName="21593SDK01_Core2" -proc ADSP-21593 -si-revision any -g -DCORE2 -D_DEBUG -DADI_MCAPI @includes-b8e320e29dcf71f328223af7514cf29b.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "src/AudioAlgorithms/Postprocessing/DTSX/Kernel/DTSX_Kernel_asm.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '

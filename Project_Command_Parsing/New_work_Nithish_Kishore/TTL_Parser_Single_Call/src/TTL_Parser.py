...
def extract_bitfields_parameter(command_value, parameter_values, parameter_number, datas, path, file_format,Parameter_buffer):
...
def command_validation(command,parameter,parameter_no,dictionary,path,file_format,Parameter_buffer): # This function validates a command from a file (either JSON or YAML) and retrieves details about it.

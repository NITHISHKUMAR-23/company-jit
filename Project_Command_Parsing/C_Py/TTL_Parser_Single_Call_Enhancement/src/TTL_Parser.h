...
char *Full_Command_Details;
char *parameter_string;


char* TTL_File = "D:\\Project_Command_Parsing\\C_Py\\TTL_Parser_Single_Call_Enhancement\\Input_Files\\TTL_Input_file.ttl";
char* OUT_File = "Output.txt";
char* Json_File= "D:\\Project_Command_Parsing\\C_Py\\TTL_Parser_Single_Call_Enhancement\\Input_Files\\Command_Reference_JSON.json";
char* Yaml_File= "D:\\Project_Command_Parsing\\C_Py\\TTL_Parser_Single_Call_Enhancement\\Input_Files\\Command_Reference_YAML.yaml";
...
char* c_to_python_call(char*,char*,char*,char*,uint32_t, char*, int);

...
#if  ((ADI_IIR_CFG_ACCELERATOR_MODE == ADI_IIR_ACCELERATOR_MODE_ACM) || (defined(__ADSPSC594_FAMILY__) || defined(__ADSPSC598_FAMILY__)))
#if  !((defined(__ADSPSC594_FAMILY__) || defined(__ADSPSC598_FAMILY__)) && (ADI_IIR_CFG_ACCELERATOR_MODE == ADI_IIR_ACCELERATOR_MODE_LEGACY))
                true,                                                     /* Callback Enable */
#endif /* !((defined(__ADSPSC594_FAMILY__) || defined(__ADSPSC598_FAMILY__)) && (ADI_IIR_CFG_ACCELERATOR_MODE == ADI_IIR_ACCELERATOR_MODE_LEGACY)) */
...
#endif /* !((defined(__ADSPSC594_FAMILY__) || defined(__ADSPSC598_FAMILY__)) && (ADI_IIR_CFG_ACCELERATOR_MODE == ADI_IIR_ACCELERATOR_MODE_LEGACY)) */
#endif /* ((ADI_IIR_CFG_ACCELERATOR_MODE == ADI_IIR_ACCELERATOR_MODE_ACM) || (defined(__ADSPSC594_FAMILY__) || defined(__ADSPSC598_FAMILY__))) */

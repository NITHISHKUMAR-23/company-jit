/*
 **
 ** Source file generated on May 12, 2021 at 17:04:08.	
 **
 ...
 ** GPIO (unavailable)
 ** ------------------
 ** PA00, PA01, PA02, PA03, PA04, PA05, PA14, PA15, PE04, PE05
 */
...
#define TWI2_SCL_PORTE_MUX  ((uint16_t) ((uint16_t) 0<<8))
#define TWI2_SDA_PORTA_MUX  ((uint32_t) ((uint32_t) 0<<30))
#define TWI2_SDA_PORTE_MUX  ((uint16_t) ((uint16_t) 0<<10))
...
#define TWI2_SCL_PORTE_FER  ((uint16_t) ((uint16_t) 1<<4))
#define TWI2_SDA_PORTA_FER  ((uint32_t) ((uint32_t) 1<<15))
#define TWI2_SDA_PORTE_FER  ((uint16_t) ((uint16_t) 1<<5))
...
int32_t adi_initpinmux(void) {
    ...
    *pREG_PORTE_MUX = TWI2_SCL_PORTE_MUX | TWI2_SDA_PORTE_MUX;
    ...
    *pREG_PORTE_FER = TWI2_SCL_PORTE_FER | TWI2_SDA_PORTE_FER;
    return 0;
}

...
#if defined(__ADSPSC594__) || defined(__ADSPSC592__) ||  defined(__ADSPSC594W__) || defined(__ADSPSC592W__) \
 ||  defined(__ADSP21594__) || defined(__ADSP21594W__) || defined(__ADSPSC591W__) || defined(__ADSPSC598_FAMILY__)
...
/*! This configuration sets the baud rate for the SPI data transfers\n
    Baud can be calculated as BAUD = (SCLK0_0/SPI_Clock) - 1\n */
#define ADI_SPI1_CFG_CLK_BAUD                         50ul
/**************************************************************************************************************/
...
/*! Configures whether the SPI starts toggling the signal for the SPI clock\n
    ...
    (0) - Serial clock pulses at the end of each serial bit transfer\n
    (1) - Serial clock pulses at the beginning of each serial bit transfer\n*/
#define ADI_SPI1_CFG_CLK_PHASE                        0x0ul
...
/*! Configure in Default or Dual I/O or Quad I/O mode\n
    ...
    (0) - SPI with MOSI and MISO, single I/O mode\n
    (1) - Dual I/O mode\n
    (2) - Dual I/O mode.(Not applicabel for SPI1)\n*/
...
/*! Enable SPI MISO mode. This mode is only applicable for SPI as a slave\n
    ...
    (0) - Disable\n
    (1) - Enable\n*/
#define ADI_SPI1_CFG_ENABLE_MISO                      0x1ul
...
/*! This configuration sets the baud rate for the SPI data transfers\n
    Baud can be calculated as BAUD = (SCLK0_0/SPI_Clock) - 1\n */
#define ADI_SPI2_CFG_CLK_BAUD                         50ul
/**************************************************************************************************************/
...
/*! Master or Slave mode of operation\n
    ...
    (0) - Slave mode\n
    (1) - Master mode\n*/
#define ADI_SPI2_CFG_SLAVE_MASTER                     0x0ul
...
/*! Configures whether the SPI starts toggling the signal for the SPI clock\n
    ...
    (0) - Serial clock pulses at the end of each serial bit transfer\n
    (1) - Serial clock pulses at the beginning of each serial bit transfer\n*/
#define ADI_SPI2_CFG_CLK_PHASE                        0x0ul
...
/*! Configure in Default or Dual I/O or Quad I/O mode\n
    ...
    (0) - SPI with MOSI and MISO, single I/O mode\n
    (1) - Dual I/O mode\n
    (2) - Dual I/O mode.(Not applicabel for SPI2)\n*/
...
/*****************************************************************************************************************/
#endif /* end of HPC family macro check (__ADSPSC594__) || (__ADSPSC592__) ||  (__ADSPSC594W__) || (__ADSPSC592W__) \
 || (__ADSP21594__) || (__ADSP21594W__) || (__ADSPSC591W__) || (__ADSPSC598_FAMILY__)) */

/*
 **
 ** Source file generated on May 14, 2021 at 18:33:10.	
 **
 ...
 ** --------------------
 ** SPI2 (CLK, D2, D3, MISO, MOSI, RDY, SEL1)
 ** TWI2 (SCL, SDA)
 **
 ** GPIO (unavailable)
 ** ------------------
 ** PA00, PA01, PA02, PA03, PA04, PA05, PA14, PA15, PB05
 */
...
#define SPI2_RDY_PORTB_MUX  ((uint16_t) ((uint16_t) 1<<10))
...
#define SPI2_RDY_PORTB_FER  ((uint16_t) ((uint16_t) 1<<5))
...
int32_t adi_initpinmux(void) {
    ...
    *pREG_PORTB_MUX = SPI2_RDY_PORTB_MUX;
    ...
    *pREG_PORTB_FER = SPI2_RDY_PORTB_FER;
    return 0;
}

/*
 **
 ** Source file generated on September 19, 2022 at 11:30:58.	
 **
 ...
 ** --------------------
 ** EMSI0 (CD, CLK, CMD, D0, D1, D2, D3, D4, D5, D6, D7, LED_CONTROL, RST, WP)
 ** TWI2 (SCL, SDA)
 **
 ** GPIO (unavailable)
 ** ------------------
 ** PA14, PA15, PB15, PC04, PC06, PD15, PE01, PE06, PE08, PE09, PG01, PG02, PG08,
 ** PG09, PG10, PI06
 */
...
int32_t adi_initpinmux(void) {
    ...
    *pREG_PORTG_MUX = EMSI0_CMD_PORTG_MUX | EMSI0_D4_PORTG_MUX
     | EMSI0_D5_PORTG_MUX | EMSI0_D6_PORTG_MUX | EMSI0_D7_PORTG_MUX;
    ...
    *pREG_PORTG_FER = EMSI0_CMD_PORTG_FER | EMSI0_D4_PORTG_FER
     | EMSI0_D5_PORTG_FER | EMSI0_D6_PORTG_FER | EMSI0_D7_PORTG_FER;

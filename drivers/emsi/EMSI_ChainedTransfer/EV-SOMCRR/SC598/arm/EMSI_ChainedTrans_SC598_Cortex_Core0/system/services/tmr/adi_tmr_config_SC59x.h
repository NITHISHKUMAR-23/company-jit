...
static configuration will not be done and the default reset configuration is retained. */
...
/*!Enable the static configuration for Timer 10*/
#define ADI_TMR_TMR10	1
/*!Enable the static configuration for Timer 11*/
#define ADI_TMR_TMR11	1
/*!Enable the static configuration for Timer 12*/
#define ADI_TMR_TMR12	1
/*!Enable the static configuration for Timer 13*/
#define ADI_TMR_TMR13	1
/*!Enable the static configuration for Timer 14*/
#define ADI_TMR_TMR14	1
/*!Enable the static configuration for Timer 15*/
#define ADI_TMR_TMR15	1
...
/*!The period value for timer operation in SCLK cycles. This field is valid only for PWM Out modes, Windowed WDOG modes and External clock mode. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER1_PERIOD			2000u
...
/*!The period value for timer operation in SCLK cycles. This field is valid only for PWM Out modes, Windowed WDOG modes and External clock mode. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER2_PERIOD			2000u
...
/*!The period value for timer operation in SCLK cycles. This field is valid only for PWM Out modes, Windowed WDOG modes and External clock mode. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER3_PERIOD			2000u
...
/*!The period value for timer operation in SCLK cycles. This field is valid only for PWM Out modes, Windowed WDOG modes and External clock mode. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER4_PERIOD			2000u
...
/*!The period value for timer operation in SCLK cycles. This field is valid only for PWM Out modes, Windowed WDOG modes and External clock mode. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER5_PERIOD			2000u
...
/*!The period value for timer operation in SCLK cycles. This field is valid only for PWM Out modes, Windowed WDOG modes and External clock mode. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER6_PERIOD			2000u
...
/*!The period value for timer operation in SCLK cycles. This field is valid only for PWM Out modes, Windowed WDOG modes and External clock mode. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER7_PERIOD			2000u
...
/*!The period value for timer operation in SCLK cycles. This field is valid only for PWM Out modes, Windowed WDOG modes and External clock mode. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER8_PERIOD			2000u
...
/*!The period value for timer operation in SCLK cycles. This field is valid only for PWM Out modes, Windowed WDOG modes and External clock mode. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER9_PERIOD			2000u
...
#if (ADI_TMR_TMR10==1)
/* TIMER10 Instance */
/*! Select TIMER10 Instance */
#define ADI_TIMER10_INSTANCE                     1u

/*!Selects the mode of operation for the Timer10.
Following are the valid values that can be assigned to the macro
	...
	ADI_TMR_MODE_PINT               - Pin interrupt mode
*/
#define ADI_TIMER10_MODE        		ADI_TMR_MODE_CONTINUOUS_PWMOUT

/*!Selects the IRQ Mode of operation of the Timer10.
Following are the valid values that can be assigned to the macro
    ...
    ADI_TMR_IRQMODE_PERIOD          - Generate interrupt after timer counts till TMR_PERIOD register value. This is valid for the Continuous PWMOUT mode and EXTCLK mode.
*/
#define ADI_TIMER10_IRQ_MODE			ADI_TMR_IRQMODE_PERIOD

/*!Selects the pulse polarity of the timer pin, true=active high*/
#define ADI_TIMER10_PULSE_POLARITY  	false

/*!Selects the clock input source of the Timer10.
Following are the valid values that can be assigned to the macro
	...
	ADI_TMR_CLKIN_ALTCLK1       - Use alternative clock input source 1.
*/
#define ADI_TIMER10_CLKIN_SOURCE		ADI_TMR_CLKIN_SYSCLK

/*!Selects the input of the timer, true=Auxiliary input pin, false=timer pin input*/
#define ADI_TIMER10_INPUT_AUXIN		false

/*!The period value for timer operation in SCLK cycles. This field is valid only for PWM Out modes, Windowed WDOG modes and External clock mode. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER10_PERIOD			2000u

/*!The width value for timer operation in SCLK cycles. This field is valid only for PWM Out modes. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER10_WIDTH			500u

/*!The delay value for timer operation in SCLK cycles. This field is valid only for PWM Out modes and windowed WDOG modes. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER10_DELAY			0u

/*!Choose the stop configuration of the timer as abrupt stop or graceful stop*/
/*!This option is valid only in the PWM OUT modes*/
#define ADI_TIMER10_ENABLE_GRACEFUL_STOP    true

/*!If true, then the timer runs during emulation.*/
#define ADI_TIMER10_EMULATION_RUN          false

#endif /*(ADI_TMR_TMR10==1)*/

/*------------------TIMER 11------------------------------------*/
#if (ADI_TMR_TMR11==1)
/* TIMER11 Instance */
/*! Select TIMER11 Instance */
#define ADI_TIMER11_INSTANCE                     1u

/*!Selects the mode of operation for the Timer11.
Following are the valid values that can be assigned to the macro
	...
	ADI_TMR_MODE_PINT               - Pin interrupt mode
*/
#define ADI_TIMER11_MODE        		ADI_TMR_MODE_CONTINUOUS_PWMOUT

/*!Selects the IRQ Mode of operation of the Timer11.
Following are the valid values that can be assigned to the macro
    ...
    ADI_TMR_IRQMODE_PERIOD          - Generate interrupt after timer counts till TMR_PERIOD register value. This is valid for the Continuous PWMOUT mode and EXTCLK mode.
*/
#define ADI_TIMER11_IRQ_MODE			ADI_TMR_IRQMODE_PERIOD

/*!Selects the pulse polarity of the timer pin, true=active high*/
#define ADI_TIMER11_PULSE_POLARITY  	false

/*!Selects the clock input source of the Timer11.
Following are the valid values that can be assigned to the macro
	...
	ADI_TMR_CLKIN_ALTCLK1       - Use alternative clock input source 1.
*/
#define ADI_TIMER11_CLKIN_SOURCE		ADI_TMR_CLKIN_SYSCLK

/*!Selects the input of the timer, true=Auxiliary input pin, false=timer pin input*/
#define ADI_TIMER11_INPUT_AUXIN		false

/*!The period value for timer operation in SCLK cycles. This field is valid only for PWM Out modes, Windowed WDOG modes and External clock mode. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER11_PERIOD			2000u

/*!The width value for timer operation in SCLK cycles. This field is valid only for PWM Out modes. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER11_WIDTH			500u

/*!The delay value for timer operation in SCLK cycles. This field is valid only for PWM Out modes and windowed WDOG modes. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER11_DELAY			0u

/*!Choose the stop configuration of the timer as abrupt stop or graceful stop*/
/*!This option is valid only in the PWM OUT modes*/
#define ADI_TIMER11_ENABLE_GRACEFUL_STOP    true

/*!If true, then the timer runs during emulation.*/
#define ADI_TIMER11_EMULATION_RUN          false

#endif /*(ADI_TMR_TMR11==1)*/

/*------------------TIMER 12------------------------------------*/
#if (ADI_TMR_TMR12==1)
/* TIMER12 Instance */
/*! Select TIMER12 Instance */
#define ADI_TIMER12_INSTANCE                     1u

/*!Selects the mode of operation for the Timer12.
Following are the valid values that can be assigned to the macro
	...
	ADI_TMR_MODE_PINT               - Pin interrupt mode
*/
#define ADI_TIMER12_MODE        		ADI_TMR_MODE_CONTINUOUS_PWMOUT

/*!Selects the IRQ Mode of operation of the Timer12.
Following are the valid values that can be assigned to the macro
    ...
    ADI_TMR_IRQMODE_PERIOD          - Generate interrupt after timer counts till TMR_PERIOD register value. This is valid for the Continuous PWMOUT mode and EXTCLK mode.
*/
#define ADI_TIMER12_IRQ_MODE			ADI_TMR_IRQMODE_PERIOD

/*!Selects the pulse polarity of the timer pin, true=active high*/
#define ADI_TIMER12_PULSE_POLARITY  	false

/*!Selects the clock input source of the Timer12.
Following are the valid values that can be assigned to the macro
	...
	ADI_TMR_CLKIN_ALTCLK1       - Use alternative clock input source 1.
*/
#define ADI_TIMER12_CLKIN_SOURCE		ADI_TMR_CLKIN_SYSCLK

/*!Selects the input of the timer, true=Auxiliary input pin, false=timer pin input*/
#define ADI_TIMER12_INPUT_AUXIN		false

/*!The period value for timer operation in SCLK cycles. This field is valid only for PWM Out modes, Windowed WDOG modes and External clock mode. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER12_PERIOD			2000u

/*!The width value for timer operation in SCLK cycles. This field is valid only for PWM Out modes. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER12_WIDTH			500u

/*!The delay value for timer operation in SCLK cycles. This field is valid only for PWM Out modes and windowed WDOG modes. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER12_DELAY			0u

/*!Choose the stop configuration of the timer as abrupt stop or graceful stop*/
/*!This option is valid only in the PWM OUT modes*/
#define ADI_TIMER12_ENABLE_GRACEFUL_STOP    true

/*!If true, then the timer runs during emulation.*/
#define ADI_TIMER12_EMULATION_RUN          false

#endif /*(ADI_TMR_TMR12==1)*/

/*------------------TIMER 13------------------------------------*/
#if (ADI_TMR_TMR13==1)
/* TIMER13 Instance */
/*! Select TIMER13 Instance */
#define ADI_TIMER13_INSTANCE                     1u

/*!Selects the mode of operation for the Timer13.
Following are the valid values that can be assigned to the macro
	...
	ADI_TMR_MODE_PINT               - Pin interrupt mode
*/
#define ADI_TIMER13_MODE        		ADI_TMR_MODE_CONTINUOUS_PWMOUT

/*!Selects the IRQ Mode of operation of the Timer13.
Following are the valid values that can be assigned to the macro
    ...
    ADI_TMR_IRQMODE_PERIOD          - Generate interrupt after timer counts till TMR_PERIOD register value. This is valid for the Continuous PWMOUT mode and EXTCLK mode.
*/
#define ADI_TIMER13_IRQ_MODE			ADI_TMR_IRQMODE_PERIOD

/*!Selects the pulse polarity of the timer pin, true=active high*/
#define ADI_TIMER13_PULSE_POLARITY  	false

/*!Selects the clock input source of the Timer13.
Following are the valid values that can be assigned to the macro
	...
	ADI_TMR_CLKIN_ALTCLK1       - Use alternative clock input source 1.
*/
#define ADI_TIMER13_CLKIN_SOURCE		ADI_TMR_CLKIN_SYSCLK

/*!Selects the input of the timer, true=Auxiliary input pin, false=timer pin input*/
#define ADI_TIMER13_INPUT_AUXIN		false

/*!The period value for timer operation in SCLK cycles. This field is valid only for PWM Out modes, Windowed WDOG modes and External clock mode. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER13_PERIOD			2000u

/*!The width value for timer operation in SCLK cycles. This field is valid only for PWM Out modes. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER13_WIDTH			500u

/*!The delay value for timer operation in SCLK cycles. This field is valid only for PWM Out modes and windowed WDOG modes. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER13_DELAY			0u

/*!Choose the stop configuration of the timer as abrupt stop or graceful stop*/
/*!This option is valid only in the PWM OUT modes*/
#define ADI_TIMER13_ENABLE_GRACEFUL_STOP    true

/*!If true, then the timer runs during emulation.*/
#define ADI_TIMER13_EMULATION_RUN          false

#endif /*(ADI_TMR_TMR13==1)*/

/*------------------TIMER 14------------------------------------*/
#if (ADI_TMR_TMR14==1)
/* TIMER14 Instance */
/*! Select TIMER14 Instance */
#define ADI_TIMER14_INSTANCE                     1u

/*!Selects the mode of operation for the Timer14.
Following are the valid values that can be assigned to the macro
	...
	ADI_TMR_MODE_PINT               - Pin interrupt mode
*/
#define ADI_TIMER14_MODE        		ADI_TMR_MODE_CONTINUOUS_PWMOUT

/*!Selects the IRQ Mode of operation of the Timer14.
Following are the valid values that can be assigned to the macro
    ...
    ADI_TMR_IRQMODE_PERIOD          - Generate interrupt after timer counts till TMR_PERIOD register value. This is valid for the Continuous PWMOUT mode and EXTCLK mode.
*/
#define ADI_TIMER14_IRQ_MODE			ADI_TMR_IRQMODE_PERIOD

/*!Selects the pulse polarity of the timer pin, true=active high*/
#define ADI_TIMER14_PULSE_POLARITY  	false

/*!Selects the clock input source of the Timer14.
Following are the valid values that can be assigned to the macro
	...
	ADI_TMR_CLKIN_ALTCLK1       - Use alternative clock input source 1.
*/
#define ADI_TIMER14_CLKIN_SOURCE		ADI_TMR_CLKIN_SYSCLK

/*!Selects the input of the timer, true=Auxiliary input pin, false=timer pin input*/
#define ADI_TIMER14_INPUT_AUXIN		false

/*!The period value for timer operation in SCLK cycles. This field is valid only for PWM Out modes, Windowed WDOG modes and External clock mode. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER14_PERIOD			2000u

/*!The width value for timer operation in SCLK cycles. This field is valid only for PWM Out modes. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER14_WIDTH			500u

/*!The delay value for timer operation in SCLK cycles. This field is valid only for PWM Out modes and windowed WDOG modes. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER14_DELAY			0u

/*!Choose the stop configuration of the timer as abrupt stop or graceful stop*/
/*!This option is valid only in the PWM OUT modes*/
#define ADI_TIMER14_ENABLE_GRACEFUL_STOP    true

/*!If true, then the timer runs during emulation.*/
#define ADI_TIMER14_EMULATION_RUN          false

#endif /*(ADI_TMR_TMR14==1)*/

/*------------------TIMER 15------------------------------------*/
#if (ADI_TMR_TMR15==1)
/* TIMER15 Instance */
/*! Select TIMER15 Instance */
#define ADI_TIMER15_INSTANCE                     1u

/*!Selects the mode of operation for the Timer15.
Following are the valid values that can be assigned to the macro
	...
	ADI_TMR_MODE_PINT               - Pin interrupt mode
*/
#define ADI_TIMER15_MODE        		ADI_TMR_MODE_CONTINUOUS_PWMOUT

/*!Selects the IRQ Mode of operation of the Timer15.
Following are the valid values that can be assigned to the macro
    ...
    ADI_TMR_IRQMODE_PERIOD          - Generate interrupt after timer counts till TMR_PERIOD register value. This is valid for the Continuous PWMOUT mode and EXTCLK mode.
*/
#define ADI_TIMER15_IRQ_MODE			ADI_TMR_IRQMODE_PERIOD

/*!Selects the pulse polarity of the timer pin, true=active high*/
#define ADI_TIMER15_PULSE_POLARITY  	false

/*!Selects the clock input source of the Timer15.
Following are the valid values that can be assigned to the macro
	...
	ADI_TMR_CLKIN_ALTCLK1       - Use alternative clock input source 1.
*/
#define ADI_TIMER15_CLKIN_SOURCE		ADI_TMR_CLKIN_SYSCLK

/*!Selects the input of the timer, true=Auxiliary input pin, false=timer pin input*/
#define ADI_TIMER15_INPUT_AUXIN		false

/*!The period value for timer operation in SCLK cycles. This field is valid only for PWM Out modes, Windowed WDOG modes and External clock mode. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER15_PERIOD			2000u

/*!The width value for timer operation in SCLK cycles. This field is valid only for PWM Out modes. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER15_WIDTH			500u

/*!The delay value for timer operation in SCLK cycles. This field is valid only for PWM Out modes and windowed WDOG modes. The valid range is 0 to (2^32)-1*/
#define ADI_TIMER15_DELAY			0u

/*!Choose the stop configuration of the timer as abrupt stop or graceful stop*/
/*!This option is valid only in the PWM OUT modes*/
#define ADI_TIMER15_ENABLE_GRACEFUL_STOP    true

/*!If true, then the timer runs during emulation.*/
#define ADI_TIMER15_EMULATION_RUN          false

#endif /*(ADI_TMR_TMR15==1)*/

...
*********************************************************************************/
/*!
 * @file    adi_mdma_config_SC59x.h
 * @brief   Memory DMA Manager configuration macros for ADSP-SC59x processor family
 * @version $Revision$
 * @date    $Date$
 * @details
...
#ifndef __ADI_MDMA_CONFIG_SC59X_H__
#define __ADI_MDMA_CONFIG_SC59X_H__
...
/** @ingroup MDMA_Config
 *	This macro should be set if cache management is required to be done inside MDMA service.
 *	This macro should be cleared if cache management is not required to be done inside MDMA service.
 */
#define __ADI_MDMA_CACHE_MANAGEMENT			(1)

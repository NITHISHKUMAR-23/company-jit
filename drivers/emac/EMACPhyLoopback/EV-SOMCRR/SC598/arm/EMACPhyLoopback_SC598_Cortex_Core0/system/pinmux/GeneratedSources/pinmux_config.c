/*
 **
 ** Source file generated on March 14, 2022 at 15:21:50.	
 **
 ...
 ** --------------------
 ** EMAC0 (COL, CRS, MDC, MDIO, PHYINT, PTPAUX_MCG_IN0, PTPAUX_MCG_IN1, PTPAUX_MCG_IN2, PTPAUX_MCG_IN3, PTPCLKIN0, PTPPPS0, PTPPPS1, PTPPPS2, PTPPPS3, RXCLK_REFCLK, RXCTL_RXDV, RXD0, RXD1, RXD2, RXD3, RXERR, TXCLK, TXCTL_TXEN, TXD0, TXD1, TXD2, TXD3)
 ** EMAC1 (CRS, MDC, MDIO, REFCLK, RXD0, RXD1, TXD0, TXD1, TXEN)
 ** TWI2 (SCL, SDA)
 **
 ** GPIO (unavailable)
 ** ------------------
 ** PA14, PA15, PD02, PD03, PD05, PD06, PD07, PD12, PE09, PE11, PE12, PE13, PE14,
 ** PE15, PF00, PF01, PF02, PF03, PH03, PH04, PH05, PH06, PH07, PH08, PH09, PH10,
 ** PH11, PH12, PH13, PH14, PH15, PI00, PI01, PI02, PI03, PI04, PI05, PI06
 */
...
#define EMAC0_PHYINT_PORTD_MUX  ((uint32_t) ((uint32_t) 2<<24))
#define EMAC0_PTPAUX_MCG_IN0_PORTI_MUX  ((uint16_t) ((uint16_t) 1<<4))
...
#define EMAC0_PHYINT_PORTD_FER  ((uint32_t) ((uint32_t) 1<<12))
#define EMAC0_PTPAUX_MCG_IN0_PORTI_FER  ((uint16_t) ((uint16_t) 1<<2))
...
int32_t adi_initpinmux(void) {
    ...
    *pREG_PORTD_MUX = EMAC0_COL_PORTD_MUX | EMAC0_CRS_PORTD_MUX
     | EMAC0_PHYINT_PORTD_MUX | EMAC0_RXERR_PORTD_MUX;
    ...
    *pREG_PORTI_MUX = EMAC0_PTPAUX_MCG_IN0_PORTI_MUX | EMAC0_PTPCLKIN0_PORTI_MUX
    ...
    *pREG_PORTD_FER = EMAC0_COL_PORTD_FER | EMAC0_CRS_PORTD_FER
     | EMAC0_PHYINT_PORTD_FER | EMAC0_RXERR_PORTD_FER;
    ...
    *pREG_PORTI_FER = EMAC0_PTPAUX_MCG_IN0_PORTI_FER | EMAC0_PTPCLKIN0_PORTI_FER

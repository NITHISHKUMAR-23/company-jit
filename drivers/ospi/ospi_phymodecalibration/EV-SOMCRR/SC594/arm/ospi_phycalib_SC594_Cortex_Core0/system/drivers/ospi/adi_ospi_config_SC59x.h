...
Copyright (c) 2019 - 2022 Analog Devices.  All Rights Reserved.
...
#ifndef _ADI_OSPI_CONFIG_SC59x_H_
#define _ADI_OSPI_CONFIG_SC59x_H_
...
/*! Define whether the optimization scheme for PHY calibration algorithm is enabled or not 
	0U - Optimization is disabled
	1U - Optimization is enabled. 
	Recommendation is to have the optimization enabled, as unoptimized calibration routine can take
	long to complete and may affect system performance
*/
#define ADI_OSPI_PHYCALIB_OPTIMIZE    (1U)

#endif /* _ADI_OSPI_CONFIG_SC59x_H_ */

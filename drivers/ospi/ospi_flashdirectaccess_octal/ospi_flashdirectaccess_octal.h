...
*
* @brief     This is the primary header file for OSPI Octal Flash Direct read access example.
*
*/

#ifndef __OSPI_FLASHDIRECTACCESS_OCTAL_H__
#define __OSPI_FLASHDIRECTACCESS_OCTAL_H__
...
/* Octal STR/DTR mode selection enum for Flash device */
typedef enum
{
...
#endif /* __OSPI_FLASHDIRECTACCESS_OCTAL_H__ */

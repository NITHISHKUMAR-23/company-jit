...
/*****************************************************************************
 * ospi_xip_codeexecution_21593_Core1.h
 *****************************************************************************/

#ifndef __OSPI_XIP_CODEEXECUTION_H__
#define __OSPI_XIP_CODEEXECUTION_H__
...
/*
#ifndef CORE0
 For Core 1 example, always keep it defined as the loading of code as ROM sections is handled by emulator
#define FlashCodeBuild
#else
 For CORE0 example define/un-define this macro as per guidelines in readme file
#define FlashCodeBuild
#endif
*/
...
/* - This macro should only be uncommented to build the codes which maps to flash
 *   Then the dump of the code mapped to flash needs to be extracted and should be
 *   placed in ospi_flashcode.dat file in include format
 * - While running the code, this should be commented */
//#define FlashCodeBuild
...
#define FLASH_RD_VCR_MICRON			(0x85)	/*	Read volatile configuration register Micron */
#define FLASH_WR_VCR_MICRON			(0x81)	/*	Read volatile configuration register Micron */
...
#endif /* __OSPI_XIP_CODEEXECUTION_H__ */

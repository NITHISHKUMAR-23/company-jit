...
system/startup_ldf/app_IVT.doj: ../system/startup_ldf/app_IVT.s
	...
	easm21k -file-attr ProjectName="AD_Talkthrough_I2S_21593_Core2" -proc ADSP-21593 -si-revision 0.0 -g -DCORE2 -D_DEBUG @includes-403f4fe12b4437f827fbd8071c01bdfc.txt -absolute-path-dependencies -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_IVT.d" -o "$@" "$<"
...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore SHARC Assembler'
	easm21k -file-attr ProjectName="AD_Talkthrough_I2S_21593_Core2" -proc ADSP-21593 -si-revision 0.0 -g -DCORE2 -D_DEBUG @includes-403f4fe12b4437f827fbd8071c01bdfc.txt -absolute-path-dependencies -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '

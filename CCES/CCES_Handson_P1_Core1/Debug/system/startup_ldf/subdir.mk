...
system/startup_ldf/app_IVT.doj: ../system/startup_ldf/app_IVT.s
	...
	easm21k -file-attr ProjectName="CCES_Handson_P1_Core1" -proc ADSP-21593 -si-revision any -g -DCORE1 -D_DEBUG -DADI_MCAPI @includes-44fe42bb4fe648f6cfcd1fd0fe37e1e2.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_IVT.d" -o "$@" "$<"
...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore SHARC Assembler'
	easm21k -file-attr ProjectName="CCES_Handson_P1_Core1" -proc ADSP-21593 -si-revision any -g -DCORE1 -D_DEBUG -DADI_MCAPI @includes-44fe42bb4fe648f6cfcd1fd0fe37e1e2.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '

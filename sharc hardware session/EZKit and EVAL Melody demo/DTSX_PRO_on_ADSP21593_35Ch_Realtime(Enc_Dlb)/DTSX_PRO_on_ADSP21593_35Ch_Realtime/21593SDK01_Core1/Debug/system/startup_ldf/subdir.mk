...
system/startup_ldf/app_IVT.doj: ../system/startup_ldf/app_IVT.s
	...
	easm21k -file-attr ProjectName="21593SDK01_Core1" -proc ADSP-21593 -si-revision any -g -DCORE1 -D_DEBUG @includes-61f6bf9d7ce64e05f9f3040dcd70264e.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_IVT.d" -o "$@" "$<"
...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore SHARC Assembler'
	easm21k -file-attr ProjectName="21593SDK01_Core1" -proc ADSP-21593 -si-revision any -g -DCORE1 -D_DEBUG @includes-61f6bf9d7ce64e05f9f3040dcd70264e.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '

...
src/System/Framework/Downsampling.doj: ../src/System/Framework/Downsampling.asm
	...
	easm21k -file-attr ProjectName="21593SDK01_Core2" -proc ADSP-21593 -si-revision any -g -DCORE2 -D_DEBUG -DADI_MCAPI @includes-829b02e60cf9d69099200e6a4711f448.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "src/System/Framework/Downsampling.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '

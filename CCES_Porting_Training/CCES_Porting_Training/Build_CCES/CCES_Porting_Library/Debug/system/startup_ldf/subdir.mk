...
system/startup_ldf/app_IVT.doj: ../system/startup_ldf/app_IVT.s
	...
	easm21k -file-attr ProjectName="CCES_Porting_Library" -proc ADSP-21569 -si-revision 0.0 -g -DCORE0 -D_DEBUG @includes-ace524773e00c947bb47ecd72f245bb5.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_IVT.d" -o "$@" "$<"
...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore SHARC Assembler'
	easm21k -file-attr ProjectName="CCES_Porting_Library" -proc ADSP-21569 -si-revision 0.0 -g -DCORE0 -D_DEBUG @includes-ace524773e00c947bb47ecd72f245bb5.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '

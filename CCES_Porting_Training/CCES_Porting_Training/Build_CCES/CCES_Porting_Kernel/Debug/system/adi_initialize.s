...
//  Compilation time: Fri Feb 21 14:18:38 2025
//  Compiler options: -c -file-attr ProjectName=CCES_Porting_Kernel -proc ADSP-21569 -flags-compiler --no_wrap_diagnostics -si-revision 0.0 -O -Ov100 -g -save-temps -path-output .\system -DCORE0 -DMEAN -DRMS -DVARIANCE -DDEVIATION -D_DEBUG -I../../../CCES_Porting_Training/Statistical_Calculations/Files -I../../../CCES_Porting_Training/Porting_Library/Files -ID:/CCES_Porting_Training/Build_CCES/CCES_Porting_Kernel/system -structs-do-not-overlap -no-const-strings -no-multiline -warn-protos -double-size-32 -char-size-8 -swc -gnu-style-dependencies -MD -Mo system\adi_initialize.d -o system\adi_initialize.doj
...
.epcdebug:
	...
	.var = .epcline;
	.inc/binary ".\system\adi_initialize.sbn", 182, 4354;
	.var = .LNadi_initComponents.;
	.var = .LN.adi_initComponents..end;
	.byte =
		0x01,0x92,0x04,0x00,0x00,0x01,0x00,0x0D,0x00,0x00,0x00,0x00;
	.var = .LN0;
	.var = .LN.adi_initComponents..end;
	.byte =
		0x00,0x00,0x00,0x00;
...
.epcline:
	.inc/binary ".\system\adi_initialize.sbn", 4536, 921;
	.var = .LNadi_initComponents.;
	.byte =
...
.epcpubnames:
	...
	.var = .epcdebug;
	.byte =
		0x4E,0x11,0x00,0x00,0x15,0x11,0x00,0x00,0x61,0x64,0x69,0x5F,

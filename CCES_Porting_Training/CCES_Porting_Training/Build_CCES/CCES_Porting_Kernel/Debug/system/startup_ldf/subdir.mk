...
LDF_SRCS += \
../system/startup_ldf/Porting.ldf \
...
system/startup_ldf/app_IVT.doj: ../system/startup_ldf/app_IVT.s
	...
	easm21k -file-attr ProjectName="CCES_Porting_Kernel" -proc ADSP-21569 -si-revision 0.0 -g -DCORE0 -D_DEBUG @includes-c91e8d5087a977e4f6afac5ae889298c.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_IVT.d" -o "$@" "$<"
...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore SHARC Assembler'
	easm21k -file-attr ProjectName="CCES_Porting_Kernel" -proc ADSP-21569 -si-revision 0.0 -g -DCORE0 -D_DEBUG @includes-c91e8d5087a977e4f6afac5ae889298c.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '

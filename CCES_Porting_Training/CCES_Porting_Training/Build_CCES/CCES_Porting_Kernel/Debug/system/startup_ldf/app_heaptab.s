...
//  Compilation time: Fri Feb 21 14:18:35 2025
//  Compiler options: -c -file-attr ProjectName=CCES_Porting_Kernel -proc ADSP-21569 -flags-compiler --no_wrap_diagnostics -si-revision 0.0 -O -Ov100 -g -save-temps -path-output .\system\startup_ldf -DCORE0 -DMEAN -DRMS -DVARIANCE -DDEVIATION -D_DEBUG -I../../../CCES_Porting_Training/Statistical_Calculations/Files -I../../../CCES_Porting_Training/Porting_Library/Files -ID:/CCES_Porting_Training/Build_CCES/CCES_Porting_Kernel/system -structs-do-not-overlap -no-const-strings -no-multiline -warn-protos -double-size-32 -char-size-8 -swc -gnu-style-dependencies -MD -Mo system\startup_ldf\app_heaptab.d -o system\startup_ldf\app_heaptab.doj
...
.epcdebug:
	...
	.byte =
		...
		0x63,0x00,0x0C;
	.var = .epcline;
	.inc/binary ".\system\startup_ldf\app_heaptab.sbn", 182, 1336;
	.var = ldf_heap_space;
	.byte =
		0x00,0x00,0x00,0x00,0x01,0x0C,0x6C,0x64,0x66,0x5F,0x68,0x65,
		0x61,0x70,0x5F,0x6C,0x65,0x6E,0x67,0x74,0x68,0x00,0x01,0x42,
		0x02,0x00,0x00,0x05,0x03;
	.var = ldf_heap_length;
	.byte =
		0x00,0x00,0x00,0x00,0x01,0x0C,0x68,0x65,0x61,0x70,0x5F,0x74,
		0x61,0x62,0x6C,0x65,0x00,0x01,0xB8,0x05,0x00,0x00,0x05,0x03;
	.var = heap_table.;
	.byte =
		0x00,0x00,0x00,0x00,0x00,0x0B,0x03,0x04,0x00,0x00,0x0D,0xC6,
		0x05,0x00,0x00,0xB3,0x05,0x00,0x00,0x0E,0x02,0x00,0x01,0x00,
		0x00,0x00;
.epcdebug.end:
...
.epcline:
	.inc/binary ".\system\startup_ldf\app_heaptab.sbn", 1518, 299;
.epcline.end:
...
.epcpubnames:
	...
	.var = .epcdebug;
	.byte =
		0xC8,0x05,0x00,0x00,0x97,0x05,0x00,0x00,0x68,0x65,0x61,0x70,

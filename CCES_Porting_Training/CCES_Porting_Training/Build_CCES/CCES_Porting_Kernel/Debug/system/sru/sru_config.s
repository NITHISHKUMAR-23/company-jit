...
//  Compilation time: Fri Feb 21 14:18:36 2025
//  Compiler options: -c -file-attr ProjectName=CCES_Porting_Kernel -proc ADSP-21569 -flags-compiler --no_wrap_diagnostics -si-revision 0.0 -O -Ov100 -g -save-temps -path-output .\system\sru -DCORE0 -DMEAN -DRMS -DVARIANCE -DDEVIATION -D_DEBUG -I../../../CCES_Porting_Training/Statistical_Calculations/Files -I../../../CCES_Porting_Training/Porting_Library/Files -ID:/CCES_Porting_Training/Build_CCES/CCES_Porting_Kernel/system -structs-do-not-overlap -no-const-strings -no-multiline -warn-protos -double-size-32 -char-size-8 -swc -gnu-style-dependencies -MD -Mo system\sru\sru_config.d -o system\sru\sru_config.doj
...
.epcdebug:
	...
	.var = .epcline;
	.inc/binary ".\system\sru\sru_config.sbn", 160, 2334;
	.var = .LNadi_SRU_Init.;
	.var = .LN.adi_SRU_Init..end;
	.byte =
		0x01,0x92,0x04,0x00,0x00,0x01,0x00,0x0B,0x00,0x00,0x00,0x00;
	.var = .LN0;
	.var = .LN.adi_SRU_Init..end;
	.byte =
		0x00,0x00,0x00,0x00;
...
.epcline:
	.inc/binary ".\system\sru\sru_config.sbn", 2494, 731;
	.var = .LNadi_SRU_Init.;
	.byte =
...
.epcpubnames:
	...
	.var = .epcdebug;
	.byte =
		0x6A,0x09,0x00,0x00,0x37,0x09,0x00,0x00,0x61,0x64,0x69,0x5F,

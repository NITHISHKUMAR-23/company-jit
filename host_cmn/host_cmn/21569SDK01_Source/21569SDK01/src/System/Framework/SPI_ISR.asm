...
NOT_INTR:
	...
	I_ACALL (FLAG_TOGGLE_ROUTINE_LOW);
...
I_ALABEL_SPI_(FLAG_TOGGLE_ROUTINE)
...
I_ALABEL_SPI_(FLAG_TOGGLE_ROUTINE_LOW)
...
I_ALABEL_ALG_ (save_lbrm_reg_spi)
...
I_ALABEL_ALG_ (unsave_lbrm_reg_spi)

...
void CUSTOMER_PP_COMMAND(void)
{
	...
	Frmwk.Spi.STATUS_BYTE10	= (Frmwk.Spi.PARAMETER_1)&0x3;
	Frmwk.Spi.RESERVED_BYTE5     = 	(Frmwk.Spi.PARAMETER_1)&0x3;


}
int led_ON_OFF=0, one_second=0, two_second=0;
int mute_channel=0;

void LED_ON_OFF(void)
{

	led_ON_OFF = (Frmwk.Spi.PARAMETER_1)&0x7;
	mute_channel = (Frmwk.Spi.PARAMETER_2)&0x1;

	if(led_ON_OFF!=0)
	{
		one_second = led_ON_OFF * 188;
		two_second = led_ON_OFF * 376;
	}

...
//-------------------------------------------------------------------
// line "..\system\adi_initialize.c":20
	modify(i7,-2) (nw);
.LN0:
// line 21
	dm(-2,i6)=m13;
...
.LN4:
// line 27
	cjump adi_initpinmux. (db); dm(i7,m7)=r2; dm(i7,m7)=.LCJ1-1;
.LCJ1:
.LN5:
	dm(-2,i6)=r0;
.LN6:
...
.LN8:
// line 31
	cjump adi_SRU_Init. (db); dm(i7,m7)=r2; dm(i7,m7)=.LCJ2-1;
.LCJ2:
.LN9:
	dm(-2,i6)=r0;
.LN10:
...
.LN12:
// line 35
	cjump adi_mcapi_Init. (db); dm(i7,m7)=r2; dm(i7,m7)=.LCJ3-1;
.LCJ3:
.LN13:
	dm(-2,i6)=r0;
.LN14:
...
.epcdebug:
	...
	.var = .epcline;
	.inc/binary ".\system\adi_initialize.sbn", 199, 4383;
	.var = .LNadi_initComponents.;
	.var = .LN.adi_initComponents..end;
	.byte =
		0x01,0x8C,0x04,0x00,0x00,0x01,0x00,0x0D,0x00,0x00,0x00,0x00;
	.var = .LN0;
	.var = .LN.adi_initComponents..end;
	.byte =
		0x0E,0x72,0x65,0x73,0x75,0x6C,0x74,0x00,0x01,0x8C,0x04,0x00,
		0x00,0x02,0x86,0x78;
...
.epcline:
	.inc/binary ".\system\adi_initialize.sbn", 4582, 1014;
	.var = .LNadi_initComponents.;
	.byte =
...
.epcpubnames:
	...
	.var = .epcdebug;
	.byte =
		0x80,0x11,0x00,0x00,0x32,0x11,0x00,0x00,0x61,0x64,0x69,0x5F,

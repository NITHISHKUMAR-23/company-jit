...
/*****************************************************************************
 * SPT_GBL_Audio_Passthrough_I2S.c
 *****************************************************************************/
...
#include "math.h"
#include <SRU.h>
#include "SPT_GBL_Audio_Passthrough_I2S.h"
...
static int Sport_Init(void)
{
	...
	/*Rx group*/
    SportRxDai1Array[0]= hSPORTDev4BRx;
...
#if !defined(__ADSPCORTEXA55__)
	DEBUG_INFORMATION( "SPORT Global ADC-DAC Audio Pass-through test I2S\n" );
#endif

...
system/startup_ldf/app_IVT.doj: ../system/startup_ldf/app_IVT.s
	...
	easm21k -file-attr ProjectName="LED_Blink_SC594_SHARC_Core2" -proc ADSP-SC594 -si-revision 0.0 -g -DCORE2 -D_DEBUG @includes-ef2819e1bb2ecac106c4e30d5a4cb765.txt -absolute-path-dependencies -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_IVT.d" -o "$@" "$<"
...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore SHARC Assembler'
	easm21k -file-attr ProjectName="LED_Blink_SC594_SHARC_Core2" -proc ADSP-SC594 -si-revision 0.0 -g -DCORE2 -D_DEBUG @includes-ef2819e1bb2ecac106c4e30d5a4cb765.txt -absolute-path-dependencies -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '

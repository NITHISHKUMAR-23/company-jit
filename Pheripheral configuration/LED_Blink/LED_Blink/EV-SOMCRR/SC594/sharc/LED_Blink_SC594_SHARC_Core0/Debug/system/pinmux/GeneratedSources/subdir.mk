...
system/pinmux/GeneratedSources/pinmux_config.o: ../system/pinmux/GeneratedSources/pinmux_config.c
	...
	arm-none-eabi-gcc -g -ffunction-sections -fdata-sections -DCORE0 -D_DEBUG @includes-a9dc6274eae7a6dd2d6b5de055b8f20d.txt -Wall -c -mproc=ADSP-SC594 -msi-revision=0.0 -gdwarf-2 -MMD -MP -MF"system/pinmux/GeneratedSources/pinmux_config.d" -o  "$@" "$<"

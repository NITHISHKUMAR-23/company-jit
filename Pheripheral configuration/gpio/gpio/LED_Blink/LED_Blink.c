...
int main(int argc, char *argv[])
{
	...
	/*Configure the Port Pin PC_04 as output for flag*/
...
#endif
	{
		...
		if (flag == 0)
		    {
		        adi_gpio_Set(ADI_GPIO_PORT_C, ADI_GPIO_PIN_4); // Set flag
		        printf("LED Blink. Flag SET.\n");
		        flag = 1; // Update state
		    }
		/*Delay*/
		...
		if (flag == 1)
		    {
		        adi_gpio_Clear(ADI_GPIO_PORT_C, ADI_GPIO_PIN_4); // Clear flag
		        printf("LED Off. Flag Clear.\n");
		        flag = 0; // Update state
		    }
		/*Delay*/
		for(i=0;i<0x1000000;i++);

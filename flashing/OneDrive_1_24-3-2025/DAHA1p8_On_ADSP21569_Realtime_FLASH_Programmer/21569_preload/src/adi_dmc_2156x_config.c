...
#if CONFIG_DMC0 == ISSI_8Gb_DDR3_533MHZ
...
#define CFG0_REG_DMC_CFG_VALUE      ((CFG0_BIT_DMC_CFG_IFWID<<BITP_DMC_CFG_IFWID)|(CFG0_BIT_DMC_CFG_SDRWID<<BITP_DMC_CFG_SDRWID)|(CFG0_BIT_DMC_CFG_SDRSIZE<<BITP_DMC_CFG_SDRSIZE)|(CFG0_BIT_DMC_CFG_EXTBANK<<BITP_DMC_CFG_EXTBANK))
...
#define CFG0_BIT_DMC_TR1_TRFC                        139ul
...
#endif /* CONFIG_DMC0 == ISSI_8Gb_DDR3_533MHZ */
/*@}*/

...
system/services/smpu/adi_smpu.doj: C:/Analog\ Devices/CrossCore\ Embedded\ Studio\ 2.9.1/SHARC/lib/src/services/Source/smpu/adi_smpu.c
	...
	cc21k -c -file-attr ProjectName="21569_preload" -proc ADSP-21569 -flags-compiler --no_wrap_diagnostics -si-revision any -g -DPRELOAD_CODE -DCORE0 -D_DEBUG @includes-a7eeaa6789e0deec3056a9176eca6501.txt -structs-do-not-overlap -no-const-strings -no-multiline -misra -misra-strict -misra-no-cross-module -misra-no-runtime -misra-testing -misra-suppress-advisory -double-size-32 -char-size-8 -swc -gnu-style-dependencies -MD -Mo "system/services/smpu/adi_smpu.d" -o "$@" "$<"
